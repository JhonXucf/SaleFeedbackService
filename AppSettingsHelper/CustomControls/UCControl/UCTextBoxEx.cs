...
namespace AppSettingsHelper
{
    ...
    public partial class UCTextBoxEx : UCControlBase
    {
        ...
        void UCTextBoxEx_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (m_isShowClearBtn)
            {
                totalWidth += this.btnClear.Width;
            }
            if (m_isShowSearchBtn)
            {
                totalWidth += this.btnSearch.Width;
            }
            if (IsShowKeyboard)
            {
                totalWidth += this.btnKeybord.Width;
            }
            this.txtInput.Size = new Size(this.Width - this.txtInput.Location.X - totalWidth, this.txtInput.Height);
        }
        ...
        {
            if (keyBoardType == AppSettingsHelper.KeyBoardType.Null)
                return;
            ...
            switch (keyBoardType)
            {
                ...
                case KeyBoardType.UCKeyBorderNum:
                    ...
                    break;
                case AppSettingsHelper.KeyBoardType.UCKeyBorderHand:
