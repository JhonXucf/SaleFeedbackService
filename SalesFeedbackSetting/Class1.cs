...
{
    public partial class Awesome : UserControl
    {
        public Awesome()
        {
            ...
            {
                if (File.Exists(@"font\FontAwesome.ttf"))
                {
                ...
                else
                {
                    ...
                    MessageBox.Show(@"file font\FontAwesome.ttf missing");
                }
            }
            if (ImageFont.Families.Length == 0)
            {
        ...
        AwesomeValues _Value = AwesomeValues.fa_address_book;
        ...
        SolidBrush foreSB = new SolidBrush(DefaultForeColor);
        private void Awesome_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreSB.Color = ForeColor;
            iconfont = new Font(ImageFont.Families[0], Font.Size, FontStyle.Bold, Font.Unit);
            FontSize = e.Graphics.MeasureString(FontValue, iconfont);
            e.Graphics.DrawString(FontValue, iconfont, foreSB, (Width - FontSize.Width) / 2, (Height - FontSize.Height) / 2);
        }
        ~Awesome()
        {
            foreSB?.Dispose(); iconfont?.Dispose();
        }
    }
}